...
export default function AlbumForm({
    ...
    return (
        <form action={action} className="space-y-8">
            ...
            <section className="border border-neutral-700 border-l-2 border-l-emerald-500 rounded-lg shadow-lg shadow-black/75 p-6">
                <div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <input
                                ...
                                className="mt-2 w-full rounded-md border border-neutral-600 bg-neutral-900 px-3 py-2 text-sm outline-none transition focus:border-emerald-500"
                            />
